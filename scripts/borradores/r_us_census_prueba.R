...
data_census_vars<-readr::read_csv(file.path(folder_data,folder_uscensus,"census_vars.csv"))
...
census_api<-readr::read_csv(file.path(folder_data,folder_uscensus,"census_api.csv"))
...
data_zcta_varsxarea_metadata %>% write_csv(.,
  file=file.path(folder_output,"data_zcta_varsxarea.csv"))
